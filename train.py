...
parser.add_argument("-dp", "--data_path", type=str, default='/Volumes/data/Walczak/Synthetic_dataset/', help="Path to the FSC147 dataset")
...
im_dir = data_path + 'images_jpg'
gt_dir = data_path + 'gt'

if not exists(args.output_dir):
    os.mkdir(args.output_dir)

# Pick device (Apple Silicon GPU via MPS if available, else CPU)
...
def train():
    print("Training on Walczak train set data")
