...
try:
    from utils import build_cluster_neighborhood_masks, normalize_channels
except ModuleNotFoundError:  # Allows running the downloaded *_refactored.py file directly.
